...
from paddlevideo.tasks import train_model, train_model_multigrid, test_model, train_dali, eval_model
...
def parse_args():
    ...
    parser.add_argument('--eval_model',
                        action='store_true',
                        help='whether to evaluate models')
...
def main():
    ...
    if args.test:
        ...
        eval_model(cfg, weights=args.weights, parallel=parallel)
